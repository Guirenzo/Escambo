...
| 📅  | **Prazo com consequência**            | Toda contratação tem prazo (sugerido pelo serviço). Proposta sem resposta em `proposal_expiry_hours` **expira** e devolve a reserva; o freelancer pede **uma** extensão, que só vale com o aceite do cliente; prazo estourado avisa as duas partes e, `deadline_grace_hours` depois, a **mediação é aberta automaticamente** (RN-021, 028 e 029). |
