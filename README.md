...
| 🔎  | **Busca com filtros**                 | Texto, categoria, **perto de mim** com raio, faixa de preço, prazo máximo, nota mínima do prestador e ordenação (relevância, preço, nota, recência, distância). Destaque só manda na relevância: "menor preço" devolve o menor preço. |
