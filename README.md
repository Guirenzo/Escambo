...
| 📎  | **Anexos no chat**                    | Imagem (JPG, PNG, GIF, WebP) ou arquivo (PDF, ZIP) por mensagem, com legenda, até 10 MB: clipe, colar ou arrastar na Sala. O tipo é reconhecido pelo **conteúdo**, não pela extensão; só as partes baixam, com o token. |
