...
| 🔎  | **Busca com filtros**                 | Texto, categoria, **perto de mim** com raio, faixa de preço, prazo máximo, nota mínima do prestador, **dia em que atende** ("quem atende sábado", só entre quem informou os dias; o card mostra "atende seg a sex") e ordenação (relevância, preço, nota, recência, distância). Destaque só manda na relevância: "menor preço" devolve o menor preço. |
...
| 🖼️  | **Perfil que vende**                 | Portfólio com imagem ou link (até 12 trabalhos), dias em que atende e tempo médio de resposta no perfil público — além de nota, nível e Escambo Score. |
