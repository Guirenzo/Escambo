...
| [🧭 Decisões de arquitetura](./docs/decisoes.md)                    | ADRs: escrow transacional, ledgers de R$ e de créditos, carteira pré-paga com gateway simulado, torna da troca, LGPD por anonimização, sessão com refresh rotativo, moderação imediata, jobs, Score explicável |
