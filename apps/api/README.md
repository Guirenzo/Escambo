...
| GET                 | `/api/admin/moderation/health`                                                  | **(admin)** saúde da moderação (ADR 47): fila e contestações esperando agora e, em `?days=` (1 a 365, padrão 30), tempo até decidir (mediana e p90), sinalizações automáticas por resultado e por sinal com o acerto, contestações e remoções por tipo |
